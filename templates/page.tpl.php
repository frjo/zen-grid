...
<?php
  ...
  if ($sidebar_first && $sidebar_second):
    $content_class = 'layout__sidebar-two';
    $sidebar_first_class = 'sidebar layout__second-sidebar';
    $sidebar_second_class = 'sidebar layout__first-sidebar';
  elseif ($sidebar_second):
    $content_class = 'layout__sidebar-second';
    $sidebar_second_class = 'sidebar layout__second-sidebar';
  elseif ($sidebar_first):
    $content_class = 'layout__sidebar-first';
    $sidebar_first_class = 'sidebar layout__first-sidebar';
  endif;
?>

<div class="page layout__page <?php print $content_class; ?>">
